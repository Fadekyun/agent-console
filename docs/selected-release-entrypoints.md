...
installer/module manifest checks precede delegation; the installer performs the
full validation/lock/alias operation. No installer means failure, never old source.
