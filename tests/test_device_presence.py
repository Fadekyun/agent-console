...
class PresenceTests(unittest.TestCase):
    ...
    def test_authoritative_master_launcher_and_app_factories_share_lifetime(self):
        ...
        import sys
        with patch.dict(os.environ,{'AGCONSOLE_DEVICE_PRESENCE':'1','AGCONSOLE_DEVICE_PRESENCE_DIR':str(self.directory)}),patch.object(sys,'argv',['presence_server','--host','127.0.0.1','--port','1','--workers','2']):
