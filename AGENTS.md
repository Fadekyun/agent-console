...
3. Update `docs/RELEASE_NOTES.md` — add a bullet under the next unreleased version.
4. Increment the SemVer version in both `pyproject.toml` and `agent_console/__init__.py` according to the scope of changes:
   - **patch** (0.1.0 → 0.1.1): bugfixes, documentation, refactoring with no API change.
   - **minor** (0.1.0 → 0.2.0): new feature, API addition, deprecation.
